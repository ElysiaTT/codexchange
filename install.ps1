...
$ScriptSource = Join-Path $ProjectRoot "scripts\codex-auth-profile.ps1"
$CmdSource = Join-Path $ProjectRoot "bin\codex-auth-profile.cmd"
...
Write-Output "Installed codex-auth-profile to: $InstallDir"
